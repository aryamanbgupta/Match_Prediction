...
| G5 | bowler coverage ≥90% on the declared population | **FAIL as measured — awaiting the user's written exception or a separate change** | 89.7% (2,746 / 3,061 slots ≥100 balls; 2025 90.5%, 2026 89.3%); 98/255 matches fully covered. `g5_coverage.txt`. The bar is not reinterpreted. |
...
Three of the four mandatory gates pass. The merge to main (step 6) waits on
